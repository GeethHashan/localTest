          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button
                ...
                className={`p-6 border-2 rounded-lg text-left transition-all ${maxQualification === 'AL'
                    ? 'border-purple-500 bg-purple-50 text-purple-900'
                    : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'
                  }`}
              >
                <div className="flex items-center">
                  <div className={`w-4 h-4 rounded-full border-2 mr-3 ${maxQualification === 'AL'
              ...
              <button
                ...
                className={`p-6 border-2 rounded-lg text-left transition-all ${maxQualification === 'OL'
                    ? 'border-purple-500 bg-purple-50 text-purple-900'
                    : 'border-gray-200 hover:border-gray-300 hover:bg-gray-50'
                  }`}
              >
                <div className="flex items-center">
                  <div className={`w-4 h-4 rounded-full border-2 mr-3 ${maxQualification === 'OL'
                      ? 'border-purple-500 bg-purple-500'
                      : 'border-gray-300'
                    }`}>
                    {maxQualification === 'OL' && (
